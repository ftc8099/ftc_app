...
/*
 * Base class with shared functionality for sample kiwi drives. All hardware-specific details are
 * handled in subclasses.
 */
public abstract class RoadRunnerKiwiDriveBase extends KiwiDrive {
    ...
    public RoadRunnerKiwiDriveBase() {
    ...
    public boolean followTrajectorySync(Trajectory trajectory) {
    ...
    public boolean waitForIdle() {
        if (!Thread.currentThread().isInterrupted() && isBusy()) {
            update();
            return false;
        }
        return true;
